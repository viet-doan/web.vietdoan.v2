...
function Landing() {
  const OldPortfolioURL = "http://anai-tbgp8ueihwl7eqbikbgy.s3-website-ap-southeast-2.amazonaws.com/index.html";
  ...
  return (
    <main className="main row">
      ...
      <div className="column landing">
        ...
        <a className='links' href={OldPortfolioURL} target='_blank' rel="noreferrer">
