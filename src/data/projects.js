...
const projects = [
  ...
  // },
  {
    ...
    languagesAndTools: 'HTML, CSS, Javascript, Typescript, TailwindCSS, React, Figma (UI/UX, Frontend Development)',
    image: TiktokAI,
